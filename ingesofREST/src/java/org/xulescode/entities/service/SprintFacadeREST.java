...
import org.xulescode.entities.Sprint;
 ...
 */
@Stateless
@Path("org.xulescode.entities.sprint")
public class SprintFacadeREST extends AbstractFacade<Sprint> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Sprint entity) {
        super.edit(entity);
    }
    ...
    public Sprint find(@PathParam("id") String id) {
