...
import org.xulescode.entities.Proyecto;
 ...
 */
@Stateless
@Path("org.xulescode.entities.proyecto")
public class ProyectoFacadeREST extends AbstractFacade<Proyecto> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Proyecto entity) {
        super.edit(entity);
    }
    ...
    public Proyecto find(@PathParam("id") String id) {
