...
import org.xulescode.entities.Rol;
 ...
 */
@Stateless
@Path("org.xulescode.entities.rol")
public class RolFacadeREST extends AbstractFacade<Rol> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Rol entity) {
        super.edit(entity);
    }
    ...
    public Rol find(@PathParam("id") String id) {
