...
import org.xulescode.entities.Tarea;
 ...
 */
@Stateless
@Path("org.xulescode.entities.tarea")
public class TareaFacadeREST extends AbstractFacade<Tarea> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Tarea entity) {
        super.edit(entity);
    }
    ...
    public Tarea find(@PathParam("id") String id) {
